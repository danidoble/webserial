...
export class PinPad extends Kernel {
    ...
    set reference(reference) {
        ...
        this.__pinPad__.operation.reference = reference.toString().replaceAll(' ', '').replaceAll('_', '-').replaceAll('.', '');
    }
    ...
    async aboutPP(callback) {
        ...
        this.__pinPad__.about.impresora = lineBuffer.substring(lineBuffer.indexOf('\x1CF') + 2, lineBuffer.indexOf('\x1CG'));
        ...
        this.__pinPad__.about.versionApp = lineBuffer.substring(lineBuffer.indexOf('\x1CD') + 2, lineBuffer.indexOf('\x1CE'));
    ...
    validateRespCP(response) {
        ...
        return new Promise(function (resolve) {
            ...
            this.__internal__.pinPad.objFinishEMV.E =
                parsedResponse.emv_key_date == null ? "" : parsedResponse.emv_key_date;
            this.__internal__.pinPad.objFinishEMV.F =
                parsedResponse.icc_csn == null ? "" : parsedResponse.icc_csn;
            this.__internal__.pinPad.objFinishEMV.G =
                parsedResponse.icc_atc == null ? "" : parsedResponse.icc_atc;
            this.__internal__.pinPad.objFinishEMV.H =
                parsedResponse.icc_arpc == null ? "" : parsedResponse.icc_arpc;
    ...
    CheckinBanda() {
        ...
        this.__internal__.pinPad.objDataVenta.IdBranch = this.__internal__.pinPad.objDataCheckinBanda.IdBranch.toUpperCase();
        this.__internal__.pinPad.objDataVenta.IdCompany = this.__internal__.pinPad.objDataCheckinBanda.IdCompany.toUpperCase();
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    if (/^[0-9]+$/.test(this1.__internal__.pinPad.objDataCheckinBanda.Merchant) === true) {
                        if (/^[0-9]+$/.test(this1.__internal__.pinPad.objDataCheckinBanda.TpOperation) === true) {
                            if (
                                /^[A-Z-a-z0-9\s]+$/g.test(this1.__internal__.pinPad.objDataCheckinBanda.Tx_Room) === true
                            ) {
                                if (
                                    /^[A-Z-a-z\s]+$/g.test(this1.__internal__.pinPad.objDataCheckinBanda.Currency) === true
                                ) {
                                    isValid = true;
                                }
                            }
    ...
    GetVoucherCliente() {
        if (this.__internal__.pinPad.contPost < 1) {
            const this1 = this;
            this.dispatch("pinPad:voucher-cliente", JSON.stringify({
                RESPUESTA: "ok",
    ...
    GetVoucherComercio() {
        if (this.__internal__.pinPad.contPost < 1) {
            const this1 = this;
            this.dispatch('pinPad:voucher-comercio', JSON.stringify({
                RESPUESTA: "ok",
    ...
    set environment(value) {
        const validEnvs = [
            'development', 'qa', 'production', 'production-alternative',
        ];
    ...
    buildUrls() {
        ...
        this.__internal__.pinPad.urlSndReimpresion = this.__internal__.pinPad.url + this.__internal__.pinPad.urlSndReimpresion;
        ...
        this.__internal__.pinPad.urlcheckin_banda = this.__internal__.pinPad.url + this.__internal__.pinPad.urlcheckin_banda;
        this.__internal__.pinPad.urlcheckin_Reaut = this.__internal__.pinPad.url + this.__internal__.pinPad.urlcheckin_Reaut;
    ...
    async receivedReadCard() {
        let processedLine;
        if (this.__internal__.pinPad.objDataTRX.MarcaTerminal.toLowerCase() === "ingenico" &&
        ...
        if (this.__pinPad__.buffer.length < this.__internal__.pinPad.MIN_RESPONSE_LENGTH) {
            processedLine = this.__internal__.pinPad.objDataTRX.MarcaTerminal.toLowerCase() === "verifone" ?
                this.__pinPad__.buffer.replace("\x02006P93A00\x03.", "") :
                this.__pinPad__.buffer.replace("\x02006P93A00\x03,", "");

            this.__internal__.pinPad.err = "";
            if (this.__pinPad__.buffer.includes("E93")) {
                this.__internal__.pinPad.err = this.__pinPad__.buffer.substring(this.__pinPad__.buffer.indexOf("E93") + 3, this.__pinPad__.buffer.indexOf("E93") + 6);
            } else if (this.__pinPad__.buffer.includes("E71")) {
                this.__internal__.pinPad.err = this.__pinPad__.buffer.substring(this.__pinPad__.buffer.indexOf("E71") + 3, this.__pinPad__.buffer.indexOf("E71") + 6);
            }

            if (this.__internal__.pinPad.err !== "" &&
                processedLine.indexOf("OPERACION       CANCELADA") === -1 &&
                processedLine.indexOf("TIEMPO         EXCEDIDO") === -1 &&
                this.__internal__.pinPad.err.length === 3) {
                if (this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "vx520" && this.__internal__.pinPad.err.substring(0, 1).toLowerCase() === "a" && this.__internal__.pinPad.contErrores < 1) {
        ...
        if (this.__pinPad__.buffer.includes("\x1CM1\x03") || this.__pinPad__.buffer.includes("\x1CM0\x03") ||
            this.__pinPad__.buffer.includes("\x1CM1\x1C") || this.__pinPad__.buffer.includes("\x1CN1\x03") ||
            this.__pinPad__.buffer.includes("\x1CN1\x1C") ||
            (this.__pinPad__.buffer.includes("P93A022\x1C") && this.__pinPad__.buffer.substring(this.__pinPad__.buffer.length - 24).includes("\x1CI") && this.__pinPad__.buffer.substring(this.__pinPad__.buffer.length - 1).includes("\x03")) ||
            (this.__pinPad__.buffer.includes("P93A800\x1C") && this.__pinPad__.buffer.substring(this.__pinPad__.buffer.length - 24).includes("\x1CI") && this.__pinPad__.buffer.substring(this.__pinPad__.buffer.length - 1).includes("\x03")) ||
            (this.__pinPad__.buffer.includes("P93A022\x1C") && this.__pinPad__.buffer.length >= 406 && this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "vx820") ||
            (this.__pinPad__.buffer.includes("P93A022\x1C") && this.__pinPad__.buffer.length >= 406 && this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "vx520") ||
            (this.__pinPad__.buffer.includes("P93A800\x1C") && this.__pinPad__.buffer.length >= 406 && this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "vx520") ||
            (this.__pinPad__.buffer.includes("P93A800\x1C") && this.__pinPad__.buffer.length >= 406 && this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "vx820") ||
            (this.__pinPad__.buffer.includes("P93A022\x1C") && this.__pinPad__.buffer.length >= 406 && this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "p400") ||
            (this.__pinPad__.buffer.includes("P93A800\x1C") && this.__pinPad__.buffer.length >= 406 && this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "p400") ||
            (this.__pinPad__.buffer.includes("P93A022\x1C") && this.__pinPad__.buffer.length >= 406 && this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "v205c") ||
            (this.__pinPad__.buffer.includes("P93A800\x1C") && this.__pinPad__.buffer.length >= 406 && this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "v205c") ||
            (this.__pinPad__.buffer.includes("P93A022\x1C") && this.__pinPad__.buffer.length >= 406 && this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "move2500") ||
            (this.__pinPad__.buffer.includes("P93A800\x1C") && this.__pinPad__.buffer.length >= 406 && this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "move2500") ||
            (this.__pinPad__.buffer.includes("P93A022\x1C") && this.__pinPad__.buffer.length >= 406 && this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "lane3000") ||
            (this.__pinPad__.buffer.includes("P93A800\x1C") && this.__pinPad__.buffer.length >= 406 && this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "lane3000")) {
            processedLine = this.__internal__.pinPad.objDataTRX.MarcaTerminal.toLowerCase() === "verifone" ?
                this.__pinPad__.buffer.replace("\x02006P93A00\x03.", "").substring(this.__pinPad__.buffer.indexOf("P93A"), this.__pinPad__.buffer.indexOf("P93A") + 7) :
                this.__pinPad__.buffer;

            if (this.__pinPad__.buffer.includes("P81APROCESANDO, NO RETIRE TARJETA") ||
        ...
        if (this.__internal__.pinPad.objDataTRX.ModeloTerminal.toLowerCase() === "vx520") {
            if (this.__pinPad__.buffer.length > 11) {
                if (this.__pinPad__.buffer.includes("P59A00")) {
                    ...
                    this.__internal__.pinPad.respuestaWS = this.__pinPad__.buffer.includes("E17") || this.__pinPad__.buffer.includes("A17") ?
    ...
    onMessageLegacy(message, name) {
        ...
        if (isEmpty(this.environment)) {
            this.__internal__.pinPad.respuestaWS = '{"RESPUESTA": "error", "ERROR": "No se pudo obtener el ambiente de conexión"}';
            this.dispatch('pinPad:error', this.__internal__.pinPad.respuestaWS);
            return;
        }
