...
export class Hopper extends Core {
  ...
  setMaxCapacity({ hopper = null, capacity = 1000 } = { hopper: null, capacity: 1000 }) {
    this.#validateHopperId(hopper);
    this.__hoppers__.levels[hopper - 1].capacity = capacity;
    return this;
  }

  setHopperName({ hopper = null, name = '' } = { hopper: null, name: '' }) {
    this.#validateHopperId(hopper);
  ...
  setHopperKey({ hopper = null, key = '' } = { hopper: null, key: '' }) {
    this.#validateHopperId(hopper);
  ...
  setHopperCurrency({ hopper = null, currency = 1 } = { hopper: null, currency: 1 }) {
    this.#validateHopperId(hopper);
  ...
  #processMessage(message) {
    if ('status' === this.lastAction) {
      ...
      message.no_code = 3;
      this.__hoppers__.levels[this.__hoppers__.current - 1].amount = this.#toSignedInt16(
        message.code[9],
        message.code[10]
      );
      message.data = this.__hoppers__.levels;
      ...
      this.dispatch('hopper:updated', this.__hoppers__.levels[(this.__hoppers__.current = -1)]);
