...
export class Boardroid extends Kernel {
  ...
  #internalMessageConfigBillPurse(code, message) {
    ...
    this.dispatch('banknote-purse:config', {
      enabled: _decimalN2 === 1,
      scrow: _decimalN3 === 1,
    });
    return message;
  }
  ...
  #internalMessageStatusBanknoteScrow(code, message) {
    ...
    this.dispatch('banknote-purse:banknote-scrow-status', {
      status: _decimal === 1,
    });
    return message;
  }
  ...
  #banknotePurseOtherDispense({ $_20 = 0, $_50 = 0, $_100 = 0, $_200 = 0, $_500 = 0, $_1000 = 0 } = {}) {
    ...
    if ($_20 < 1 && $_50 < 1 && $_100 < 1 && $_200 < 1 && $_500 < 1 && $_1000 < 1)
  ...
  async banknotePurseDispense({ $_20 = 0, $_50 = 0, $_100 = 0, $_200 = 0, $_500 = 0, $_1000 = 0 } = {}) {
    ...
    if (this.#isIct()) {
      ...
      bytes = this.#banknotePurseOtherDispense({
        $_20,
        $_50,
        $_100,
        $_200,
  ...
  async dispense({ selection = 1, second_selection = null, sensor = true, seconds = null, retry = true } = {}) {
    ...
    const bytes = this.#boardroidCheckSum([
      'F1',
      'C7',
      __channel1,
      __channel2,
  ...
  #percentageTestMatrix({ dispensed = null, limit = 80 } = {}) {
    ...
    this.dispatch('percentage:test', {
      percentage: this.#__percentage_test_matrix,
      dispensed,
    });
  }
  ...
  #internalCoinsChangeToReturn(change) {
    ...
    data.will_dispense =
      data.coins.$_10 > 0 || data.coins.$_5 > 0 || data.coins.$_2 > 0 || data.coins.$_1 > 0 || data.coins.$_50c > 0;
