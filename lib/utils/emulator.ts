...
import { Boardroid } from '../serial/boardroid';
import { Kernel } from '../serial/kernel';

export class Emulator {
  static enable = false;
  static instance: null | Kernel = null;
  static #_device_type: null | string = null;
  ...
  static #checkInstance(instance: Kernel | null = null) {
    if (!Emulator.#check()) return false;

    if (instance === null && Emulator.instance === null) return false;

    if (Emulator.instance === null && instance !== null) {
  ...
  static #boardroidOnly() {
    if (Emulator.#_device_type !== 'boardroid')
  ...
  static #jofemarOnly() {
    if (Emulator.#_device_type !== 'jofemar') throw new Error(`This function is only available for Jofemar devices`);
  ...
  static #emulate(code: any) {
    if (Emulator.instance === null) return;
  ...
  static #coinInserted(code: string[], coin: null | string = null) {
  ...
  static #banknoteInserted(code: string[], banknote: null | string | number = null) {
    let num = code[Math.floor(Math.random() * 4)];
    if (banknote !== null && !isNaN(parseFloat(banknote as unknown as string))) {
  ...
  static readBillPurse(instance = null, bill: null | string | number = null) {
    if (!Emulator.#checkInstance(instance) || !Emulator.#boardroidOnly()) return false;
    if (Emulator.instance === null) return false;
    const instanceBoardroid: Boardroid = Emulator.instance as unknown as Boardroid;
    ...
    if (instanceBoardroid.__banknote_purse.recycler.ict) {
      ...
      let pos0 = '0',
        ...
        pos3 = '0',
        pos4 = '0';
      if (bill !== null && !isNaN(parseInt(bill as unknown as string))) {
        ...
        switch (instanceBoardroid.__banknote_purse.recycler.banknote) {
          case 0: // 20$
            pos0 = random;
            break;
          case 1: // 50$
  ...
  static setConnection(instance = null) {
    if (!Emulator.#checkInstance(instance)) return false;
    if (Emulator.instance === null) return false;

    Emulator.instance.__internal__.serial.connected = true;
  }
}
