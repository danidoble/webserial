...
export class Emulator {
  ...
  static #type(instance) {
    if (typeof instance !== 'object' || !(instance instanceof Kernel))
      throw new Error(`Type ${instance.typeDevice} is not supported`);
  ...
  static setConnection(instance = null) {
    ...
    instance.__internal__.serial.connected = true;
  }
}
