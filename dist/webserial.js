...
var B = (f, r, t) => _n(f, typeof r != "symbol" ? r + "" : r, t), fe = (f, r, t) => r.has(f) || Se("Cannot " + t);
var w = (f, r, t) => (fe(f, r, "read from private field"), t ? t.call(f) : r.get(f)), S = (f, r, t) => r.has(f) ? Se("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(f) : r.set(f, t), g = (f, r, t, e) => (fe(f, r, "write to private field"), e ? e.call(f, t) : r.set(f, t), t), i = (f, r, t) => (fe(f, r, "access private method"), t);
const M = [];
for (let f = 0; f < 256; ++f)
  M.push((f + 256).toString(16).slice(1));
function fn(f, r = 0) {
...
const wn = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), Me = { randomUUID: wn };
function kn(f, r, t) {
  if (Me.randomUUID && !r && !f)
    return Me.randomUUID();
  f = f || {};
  const e = f.random || (f.rng || yn)();
...
var R, L, o, Ae, Be, _, we, x, m, te, p, ke, K;
const a = class a {
  ...
  static doorOpened(r = null) {
    var n, s;
    if (!i(n = a, o, _).call(n, r) || !i(this, o, te).call(this)) return !1;
    let t = [];
  ...
  static currentTemperature(r = null) {
    var n, s, c;
    if (!i(n = a, o, _).call(n, r) || !i(s = a, o, te).call(s)) return !1;
    let t = [];
    const e = (128 + w(a, L)).toString(16);
    switch (w(a, R)) {
      case "boardroid":
...
R = new WeakMap(), L = new WeakMap(), o = new WeakSet(), Ae = function() {
  if (a.enable === !1) throw new Error("Emulator is disabled");
  return a.enable;
}, Be = function(r) {
  if (typeof r != "object" || !(r instanceof Y))
...
const v = class v extends Fe {
  ...
  static getPinPad(r = 1) {
    return Object.values(v.devices.pinpad).find((e) => e.deviceNumber === r) ?? null;
  }
...
var k, Ne, ve, Q, qe, Re, Le, He, Oe, Ue, je, We, Qe, Ve, Je, ze;
class Y extends Fe {
  /**
   *
   ...
   */
  constructor({ filters: t = null, config_port: e = null, no_device: n = 1, device_listen_on_port: s = 1 } = {}) {
    super();
    S(this, k);
    B(this, "__internal__", {
      device_number: 1,
    ...
    t && (this.serialFilters = t), e && (this.serialConfigPort = e), n && i(this, k, Je).call(this, n), s && (typeof s == "number" || typeof s == "string") && (this.listenOnPort = s), i(this, k, je).call(this), i(this, k, We).call(this);
  }
  set listenOnPort(t) {
  ...
  async serialConnect() {
    try {
      ...
      const t = await i(this, k, qe).call(this);
      if (t.length > 0)
      ...
      }, this.__internal__.time.response_connection), await i(this, k, ve).call(this, this.__internal__.serial.bytes_connection), this.dispatch("serial:sent", {
        action: "connect",
        bytes: this.__internal__.serial.bytes_connection
      }), this.typeDevice === "relay" && i(this, k, Q).call(this, ["DD", "DD"], null), await i(this, k, Oe).call(this);
    } catch (t) {
      this.serialErrors(t);
    }
  }
  async serialForget() {
    return await i(this, k, Ue).call(this);
  }
  decToHex(t) {
  ...
  softReload() {
    i(this, k, ze).call(this), this.dispatch("serial:soft-reload", {});
  }
  async sendConnect() {
...
Q = function(t = [], e = null) {
  ...
  }).filter((s) => !i(this, k, Ne).call(this, s));
}, Re = function(t) {
  if (t) {
  ...
  for (; t.readable && this.__internal__.serial.keep_reading; ) {
    ...
    try {
      ...
      for (; n; ) {
        ...
        i(this, k, Re).call(this, s), this.__internal__.serial.response.length === null ? await i(this, k, Le).call(this) : await i(this, k, He).call(this);
      }
    } catch (n) {
      this.serialErrors(n);
    } finally {
  ...
  this.on("internal:queue", async () => {
    var e;
    await i(e = t, k, Ve).call(e);
  }), i(this, k, Qe).call(this);
}, Qe = function() {
  const t = this;
  ...
  }, e), await i(this, k, ve).call(this, t.bytes), this.dispatch("serial:sent", {
    action: t.action,
    bytes: t.bytes
...
X = new WeakMap(), pe = new WeakSet(), Ge = function() {
  D.add(this);
};
var A, E, j, y, $e, Ye, Ke, mn, me, Ze, V, J, ne, ie, re;
class gn extends Y {
  constructor({ filters: t = null, config_port: e = null, no_device: n = 1, device_listen_on_port: s = 3 } = {}) {
    ...
    if (this.__internal__.device.type = "locker", D.getCustom(this.typeDevice, n))
      throw new Error(`Device ${this.typeDevice} ${n} already exists`);
    this.__internal__.device.milliseconds = 666, this.__internal__.dispense.limit_counter = 1, i(this, y, Ye).call(this), i(this, y, $e).call(this);
  }
  serialMessage(t) {
    const e = {
      code: t,
  ...
  async status({ cell: t = 1 } = {}) {
    t = i(this, y, V).call(this, t);
    const e = i(this, y, Ke).call(this, t);
    return await this.appendToQueue(e, "status");
  }
  async enable({ cell: t = 1 } = {}) {
    t = i(this, y, V).call(this, t);
    const [e, n] = this.parseCellToColumnRow(t), s = i(this, y, me).call(this, { enable: !0, column: e, row: n });
    await this.appendToQueue(s, "activate");
  }
  async disable({ cell: t = 1 } = {}) {
    t = i(this, y, V).call(this, t);
    const [e, n] = this.parseCellToColumnRow(t), s = i(this, y, me).call(this, { enable: !1, column: e, row: n });
    await this.appendToQueue(s, "disable");
  }
  async openAll() {
    if (this.isDispensing) throw new Error("Another dispensing process is running");
    i(this, y, J).call(this), g(this, A, !0), i(this, y, ne).call(this);
    const t = [];
    for (let e = 1; e <= 90; e++) {
      const n = await this.dispense(e);
      t.push(n), g(this, E, e), i(this, y, ne).call(this);
    }
    g(this, E, 90), i(this, y, ne).call(this, t), i(this, y, J).call(this);
  }
  async enableAll() {
    i(this, y, J).call(this), g(this, A, !0), i(this, y, ie).call(this);
    for (let t = 1; t <= 90; t++)
      await this.enable(t), g(this, E, t), i(this, y, ie).call(this);
    g(this, E, 90), i(this, y, ie).call(this), i(this, y, J).call(this);
  }
  async disableAll() {
...
A = new WeakMap(), E = new WeakMap(), j = new WeakMap(), y = new WeakSet(), $e = function() {
  ...
  return this.serialLockerHexCmd(
    new Uint8Array([64, this.__internal__.device.listen_on_port, t, n, s])
  );
}, V = function(t) {
  const e = parseInt(t);
...
var l, Xe, et, tt, N, se, nt, it, rt, st, at, ot, lt, ct, ht, dt, ut, pt, _t, ft, bt, yt, wt, kt, vt, mt, Ct, xt, gt, Tt, Dt, Et, H, F, ae, P, O, It, St, Mt, Ft, Z, Ce, xe, oe, le, Pt;
class Tn extends Y {
  constructor({
    filters: t = null,
    config_port: e = null,
...
l = new WeakSet(), Xe = function() {
  ...
  const n = t.slice(4, -3), s = n.map((_e) => String.fromCharCode(this.hexToDec(_e))).join(""), [c, u] = s.split(" "), [h, b] = c.split(":"), [C, T, I] = u.split("-"), U = new Date(
    2e3 + parseInt(I),
    parseInt(T) - 1,
    parseInt(C),
    parseInt(h),
  ...
  if (n !== "0") {
    ...
    if (n === "T" && s.length === 4) {
      ...
      const c = s.map((un) => String.fromCharCode(this.hexToDec(un))).join(""), u = parseInt(c.slice(0, 2)), h = parseInt(c.slice(2, 4)), b = parseInt(c.slice(4, 6)), C = parseInt(c.slice(7, 9)), T = parseInt(c.slice(9, 11)) - 1, I = 2e3 + parseInt(c.slice(11, 13)), U = new Date(I, T, C, u, h, b), _e = {
  ...
  if (e.request = "status", t[1] && !t[2]) {
    switch (t[1]) {
      ...
      case "38":
        ...
        break;
      case "39":
        e.name = "Product detector fault", e.description = "Product detector fault", e.no_code = 18, i(this, l, ae).call(this), i(this, l, P).call(this, { type: "fault-product-detector" });
        break;
      case "41":
      ...
      case "4c":
        ...
        break;
      case "4d":
        e.name = "Interior of elevator blocked", e.description = "Interior of elevator blocked", e.no_code = 31, i(this, l, ae).call(this), this.__internal__.dispense.elevator.need_reset || (this.__internal__.dispense.elevator.need_reset = !0), i(this, l, O).call(this, { type: "interior-elevator-blocked", severity: "low" });
        break;
      case "4e":
        ...
        break;
      case "4f":
        e.name = "Waiting for product to be removed", e.description = "Waiting for product to be removed", e.no_code = 33, i(this, l, ae).call(this);
        break;
      case "50":
...
var ee, z, G, d, At, Bt, ce, Nt, qt, Rt, Lt, Ht, Ot, Ut, jt, ge, Wt, Qt, Vt, Jt, zt, Gt, $t, Yt, Kt, Zt, Xt, en, tn, nn, q, he, rn, sn, an, on, Te, de, ln, cn, De, Ee, Ie;
class Dn extends Y {
  constructor({ filters: t = null, config_port: e = null, no_device: n = 1 } = {}) {
    super({ filters: t, config_port: e, no_device: n });
    S(this, d);
    ...
    this.__internal__.serial.config_port.baudRate = 115200, this.__internal__.serial.response.length = 14, this.__internal__.time.response_connection = 600, this.__internal__.time.response_general = 4e3, this.__internal__.time.response_engines = 15e3, this.__internal__.dispense.limit_counter = 15, this.__internal__.dispense.custom_limit_counter = null, this.__internal__.dispense.backup_dispense = {
      ...
      sensor: !0,
      seconds: null
    }, i(this, d, At).call(this), i(this, d, Bt).call(this);
  }
  get totalInTubes() {
  ...
  serialMessage(t) {
    ...
    switch (t[1]) {
      ...
      case "d2":
        ...
        break;
      case "d3":
        e.request = "banknote-purse:read-recycler", e = i(this, d, Gt).call(this, t, e);
        break;
      case "d4":
  ...
  async banknotePurseConfigure({ enable: t = !1, scrow: e = !1 } = {}) {
    ...
    let n;
    return i(this, d, ce).call(this) ? n = i(this, d, rn).call(this, { enable: t, scrow: e }) : n = i(this, d, sn).call(this, { enable: t, scrow: e }), await i(this, d, q).call(this, n, "banknote-purse:config");
  }
   ...
   * @return {Promise<unknown>}
   */
  async dispense({ selection: t = 1, second_selection: e = null, sensor: n = !0, seconds: s = null, retry: c = !0 } = {}) {
  ...
  async testEngines({ singleEngine: t = !1 } = {}) {
    if (this.isDispensing) throw new Error("Another dispensing process is running");
    i(this, d, Te).call(this), g(this, ee, !0);
    const e = [];
    i(this, d, de).call(this);
    for (let n = 1; n <= 80; n++) {
      ...
      e.push(s), g(this, z, n), i(this, d, de).call(this), t || n++;
    }
    g(this, z, 80), i(this, d, de).call(this, { dispensed: e }), i(this, d, Te).call(this);
  }
  async sendCustomCode({ code: t = [] } = {}) {
...
ee = new WeakMap(), z = new WeakMap(), G = new WeakMap(), d = new WeakSet(), At = function() {
  const t = [
...
de = function({ dispensed: t = null, limit: e = 80 } = {}) {
  ...
  const e = ["20", "50", "100", "200", "500"], n = this.__banknote_purse.recycler.banknote, s = "$_" + e[n], c = parseInt(e[n]), u = this.banknotes.recycler[`p${e[n]}`], h = Math.min(Math.floor(t / c), u), b = {
  ...
  return i(this, d, ce).call(this) ? i(this, d, ln).call(this, t) : i(this, d, cn).call(this, t);
}, Ee = function(t) {
  const e = {
