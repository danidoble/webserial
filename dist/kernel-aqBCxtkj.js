...
class r extends p {
  constructor() {
    super(), r.registerType("relay"), r.registerType("locker"), r.registerType("jofemar"), r.registerType("boardroid"), r.registerType("pinpad"), r.registerType("pinpax"), r.registerType("hopper");
  }
